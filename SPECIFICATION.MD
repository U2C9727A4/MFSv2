...
4: set_p2p_mode. Adds no additional headers. Response only sent when the mode switching is successful. in-flight messages are invalidated and cleared when switching happens.  
